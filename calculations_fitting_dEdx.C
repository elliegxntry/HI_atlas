...
void calculations_fitting_dEdx() {
    ...
    for (int m = 0; m < 1; m++) {
        ...
        for (int p = 0; p < pbins_num; p++) {
            ...
            data_file_name << "root_files/" << p_and_pbar[m] << "_p" << p << "_data.root";
            TFile *file = new TFile(data_file_name.str().c_str(),"read");
            ostringstream filename;
            filename << "root_files/" << p_and_pbar[m] << "_p" << p << "_fit.root";
            ...
            distributions[p] = (TH1D*) file->Get(Form("n25_60_p%d",p));
            distributions[p]->Sumw2();
            ostringstream proton_histogram_name;
            proton_histogram_name << "total" << p_and_pbar[m] << "s_p" << p;
            ...
            pionFit_fullrange[p] = new TF1(Form("pion_n25_60_p%d_fullrange",p), dscb, -2,5,7.);
            ...
            kaonFit_fullrange[p] = new TF1(Form("kaon_n25_60_p%d_fullRange",p), dscb, -2,5,7.);
            ...
            kData[p] = new TH1D(Form("kaonData_n25_60_p%d",p),"",100,-2,5);
            for (int i = 0; i <= 100; i++) {
            ...
            protonFit_fullrange[p] = new TF1(Form("proton_n25_60_p%d_fullrange",p), dscb, -2,5,7.);
            ...
            protonData[p] = new TH1D(Form("protonData_n25_60_p%d",p),"",100,-2,5);
            for (int i = 0; i <= 100; i++) {
